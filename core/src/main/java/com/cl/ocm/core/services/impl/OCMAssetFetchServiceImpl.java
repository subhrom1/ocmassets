...
public class OCMAssetFetchServiceImpl implements OCMAssetFetchService {
    ...
    public List<OCMAsset> fetchOCMAssetLinks() {
        ...
        ocmAssetsList.add(new OCMAsset("Sunlight", "https://cdn.pixabay.com/photo/2014/02/27/16/10/tree-276014_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Bloom", "https://cdn.pixabay.com/photo/2015/04/19/08/32/marguerite-729510_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Field", "https://cdn.pixabay.com/photo/2014/01/22/19/44/flower-field-250016_1280.jpg", false));

        ocmAssetsList.add(new OCMAsset("Woods", "https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072821_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Drive", "https://cdn.pixabay.com/photo/2013/11/28/10/36/road-220058_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Birds", "https://cdn.pixabay.com/photo/2015/11/16/16/28/bird-1045954_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Path", "https://cdn.pixabay.com/photo/2015/06/19/21/24/avenue-815297_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Clouds", "https://cdn.pixabay.com/photo/2013/10/02/23/03/mountains-190055_1280.jpg", false));

        ocmAssetsList.add(new OCMAsset("Summit", "https://cdn.pixabay.com/photo/2014/10/07/13/48/mountain-477832_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Snow Mountain", "https://cdn.pixabay.com/photo/2015/04/23/22/01/mountains-736886_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Help", "https://cdn.pixabay.com/photo/2016/11/08/05/20/sunset-1807524_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Sunrise", "https://cdn.pixabay.com/photo/2015/01/07/15/51/woman-591576_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Dew", "https://cdn.pixabay.com/photo/2014/09/14/18/04/dandelion-445228_1280.jpg", false));

        ocmAssetsList.add(new OCMAsset("Rose", "https://cdn.pixabay.com/photo/2013/08/22/19/18/flowers-174817_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Red Flower", "https://cdn.pixabay.com/photo/2013/04/03/21/25/flower-100263_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Blue Rose", "https://cdn.pixabay.com/photo/2013/07/21/13/00/rose-165819_1280.jpg", false));
        ocmAssetsList.add(new OCMAsset("Bunch", "https://cdn.pixabay.com/photo/2014/06/22/05/49/red-374318_1280.jpg", false));
